...
\begin{figure}[t]
\centering
%% TODO(fig): replace with fig/pipeline.pdf -- placeholder reserves the space.
\framebox[\columnwidth]{\rule{0pt}{5.0cm}\parbox{0.8\columnwidth}{\centering
\textbf{[Fig.~1 placeholder]}\\ AIAgNav processing pipeline}}
...
\label{sec:switching}
Multi-row operation is sequenced by a finite state machine. On a confirmed open
